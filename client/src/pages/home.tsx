      ...
      <nav className="fixed top-0 w-full z-50 bg-[#faf8f5]/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
             <img src={newLogoImg} alt="Dra. Maria Laura Logo" className="h-16 w-auto object-contain mix-blend-multiply contrast-125 brightness-90" />
          ...
          <div className="grid lg:grid-cols-4 gap-16 mb-24">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-4 mb-8">
                <img src={newLogoImg} alt="Logo" className="h-24 w-auto object-contain brightness-0 invert" />
